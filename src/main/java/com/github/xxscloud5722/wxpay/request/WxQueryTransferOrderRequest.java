...
import com.github.xxscloud5722.wxpay.response.WxQueryTransferOrderResponse;
...
@Data
public class WxQueryTransferOrderRequest implements IWxRequest {
    ...
    public Class<? extends IWxResponse> getResponseClass() {
        return WxQueryTransferOrderResponse.class;
    }
}
