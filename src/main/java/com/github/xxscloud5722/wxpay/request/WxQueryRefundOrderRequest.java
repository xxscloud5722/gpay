...
import com.github.xxscloud5722.wxpay.response.WxQueryRefundOrderResponse;
import lombok.Data;
...
@Data
public class WxQueryRefundOrderRequest implements IWxRequest {
    ...
    public Class<? extends IWxResponse> getResponseClass() {
        return WxQueryRefundOrderResponse.class;
    }
}
